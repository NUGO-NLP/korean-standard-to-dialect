...
word_dict_gs_filename = os.path.join(current_path, 'model/save/rulebase_word_dict_gs.json')
word_dict_jl_filename = os.path.join(current_path, 'model/save/rulebase_word_dict_jl.json')
